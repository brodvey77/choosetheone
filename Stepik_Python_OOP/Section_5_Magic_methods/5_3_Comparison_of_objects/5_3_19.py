class Month:
    ...
    def _to_tuple(self, other):
        """Вспомогательный метод для преобразования объекта в кортеж для сравнения"""
        if isinstance(other, Month):
            return (other.year, other.month)
    ...
    def __eq__(self, other):
        result = self._to_tuple(other)
        if result is NotImplemented:
            return NotImplemented
        return (self.year, self.month) == result
